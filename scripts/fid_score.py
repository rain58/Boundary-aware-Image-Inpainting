...
parser.add_argument('--txt', type=str, help=('Path to the generated images or to .npz statistic files'))
parser.add_argument('--batch-size', type=int, default=45, help='Batch size to use')
...
def get_activations(images, model, batch_size=45, dims=2048,
...
def calculate_activation_statistics(images, model, batch_size=45,
...
if __name__ == '__main__':
    ...
    with open(args.txt,mode="a") as f:
        f.write(args.path[1]+"  ")
        f.write("FID: %.4f  " % round(fid_value, 4))
